	...
	stages {
        ...
        stage('Tests'){
            ...
            steps{
                ...
                compose-bin/bin/moodle-docker-compose exec -T --user 127 webserver php $MOODLE_DOCKER_WWWROOT/admin/tool/behat/cli/init.php
                compose-bin/bin/moodle-docker-compose exec -T --user 127 webserver php $MOODLE_DOCKER_WWWROOT/admin/tool/behat/cli/run.php --tags=@auth_manual
